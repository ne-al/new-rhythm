...
import 'package:jiosaavn_handler/src/helper/extension.dart';
import 'package:jiosaavn_handler/src/helper/get_image.dart';
    ...
    if (list.isNotEmpty) {
      for (int i = 0; i < list.length; i++) {
        ...
        if (item['type'] == 'song') {
          ...
          //     cachedDetails =
          //         await Api().fetchSongDetails(item['id'].toString());
          //     Hive.box('cache')
